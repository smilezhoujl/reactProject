  ...
  // app
  {
    ...
    routes: [
      ...
      // user add menus ~ datacenter
      {
        ...
        routes: [
          {
            path: '/vpe/chartstable',
            name: 'charttable',
            component: './vpe/ChartsTable', 
          },
          {
            path: '/vpe/stepsline',
            name: 'stepline',
            component: './vpe/StepsLine', 
          },
          {
            path : '/vpe/pricetrends',
            name : 'pricetrends',
          ...
          },
          {
            ...
            name: "AntDesignProDoc",
          },
          {
            path: 'https://2x.ant.design/components/steps-cn/',
            target: '_blank', // 点击新窗口打开
            name: "AntDesignDoc",
          },
          {
